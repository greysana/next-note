...
import { FaLink, FaUnlink, FaExternalLinkAlt, FaMinus } from "react-icons/fa";

type EnhancedLinkGroupProps = {
  editor: Editor;
  onLinkClick: () => void;
};

export const EnhancedLinkGroup = ({ editor, onLinkClick }: EnhancedLinkGroupProps) => {
  const removeLink = () => {
