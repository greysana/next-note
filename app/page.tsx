...
import { FolderIcon, DocumentTextIcon, PlusIcon } from "@heroicons/react/24/outline";
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <div className="p-8 max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white/70 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-white/20">
            <h2 className="text-2xl font-bold mb-6 text-gray-800">Recent Notes</h2>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-8 rounded-2xl text-white text-center">
          <h2 className="text-2xl font-bold mb-4">Ready to organize your thoughts?</h2>
          <p className="mb-6 opacity-90">Start creating and organizing your notes with our intuitive folder system.</p>
          <Link
            href="/notes/new"
